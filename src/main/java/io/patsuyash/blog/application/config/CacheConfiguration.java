...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("BlogManagementBackendApplication");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("BlogManagementBackendApplication");
        ...
        config.getMapConfigs().put("io.patsuyash.blog.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
